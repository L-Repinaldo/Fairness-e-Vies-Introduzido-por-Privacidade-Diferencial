...
from experiments import run_experimemnt, run_plots
...
if __name__ == '__main__':
    ...
    for model_name, runner in experiments:
        ...
        data_output, model_output,setor_output = run_experimemnt(model_name= model_name, model_runner= runner, 
        ...
        run_plots(df_setor= df_setor, df_classification= df_classification, df_data= df_data)